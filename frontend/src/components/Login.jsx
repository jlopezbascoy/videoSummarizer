        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              {error && (
                <div style={{ padding: '14px 16px', borderRadius: '8px', background: `${colors.error}10`, border: `1px solid ${colors.error}50`, color: colors.error, fontSize: '0.85rem', textAlign: 'left', animation: 'shakeAndFadeIn 0.5s ease-out' }}>
                  {`[ERROR] ${error}`}
                </div>
              )}
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    transition: 'all 200ms ease', opacity: isAnyLoading ? 0.5 : 1,
                  }}
                  onMouseEnter={(e) => { if (!isAnyLoading) { e.currentTarget.style.color = colors.primary; e.currentTarget.style.filter = `drop-shadow(0 0 8px ${colors.primaryGlow})`; } }}
                  onMouseLeave={(e) => { if (!isAnyLoading) { e.currentTarget.style.color = showPassword ? colors.primary : colors.textSecondary; e.currentTarget.style.filter = 'none'; } }}
