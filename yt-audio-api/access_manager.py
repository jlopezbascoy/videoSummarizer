...
Crafted with precision by Alperen Sümeroglu – bringing clean code and clean audio together.
"""
...
def delete_expired_files(files: list) -> None:
    ...
    for file in files:
        try:
            full_path = Path(ABS_DOWNLOADS_PATH) / file  # FIXED: Use ABS_DOWNLOADS_PATH instead of DOWNLOADS_DIRECTORY
